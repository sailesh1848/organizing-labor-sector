...
@Component({
  selector: "app-gov-add-labour",
  templateUrl: "./gov-add-labour.component.html",
  styleUrls: ["./gov-add-labour.component.css"],
})
export class GovAddLabourComponent implements OnInit {
