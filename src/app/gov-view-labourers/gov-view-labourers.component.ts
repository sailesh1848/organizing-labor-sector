...
@Component({
  selector: "app-gov-view-labourers",
  templateUrl: "./gov-view-labourers.component.html",
  styleUrls: ["./gov-view-labourers.component.css"],
})
export class GovViewLabourersComponent implements OnInit {
  ELEMENT_DATA: Labour[];
