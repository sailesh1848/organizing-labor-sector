...
@Component({
  selector: "app-admin-view-employers",
  templateUrl: "./admin-view-employers.component.html",
  styleUrls: ["./admin-view-employers.component.css"],
})
export class AdminViewEmployersComponent implements OnInit {
